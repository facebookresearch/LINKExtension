...
y0['node_id'] = range(len(y0[25])) # change here for each part
...
clf = LogisticRegression(penalty="l2", solver="lbfgs", C=10e20, max_iter = 3000).fit(
    scaler
...
""":py"""
with open('REVISED_rocauc_v2_ud_w_part2_multilayer_iteration_'+str(i)+'.npy', 'wb') as f:
